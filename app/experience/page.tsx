...
export const metadata: Metadata = {
  ...
  description:
    "25+ years building marketing organizations for Fortune 500 brands, startups, and everything in between. View my complete work history.",
};
  ...
  const jobs = [
    {
      ...
      description:
        "Strategic marketing consultant specializing in brand transformation, digital strategy, and go-to-market execution for technology companies and enterprise organizations.",
      achievements: [
    ...
    },
    {
      ...
      period: "1999 – 2011",
      description:
        "Progressive leadership roles across hospitality, sports marketing, and e-commerce spanning 12 years of brand development and revenue growth.",
      achievements: [
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex items-center justify-between py-4">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <Link href="/experience" className="text-sm text-yellow-400">
                Experience
              </Link>
              <Link
                href="/#about"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-[#6b6b6b] text-[17px] md:text-[19px] leading-relaxed max-w-3xl">
              25+ years building marketing organizations for Fortune 500 brands,
              startups, agencies, and my own ventures. Here&apos;s the complete
              timeline.
            </p>
          </div>
          ...
          <div className="mt-20 bg-black text-white p-12 rounded-lg text-center">
            ...
            <p className="text-white/80 text-[17px] leading-relaxed mb-8 max-w-2xl mx-auto">
              Book a free 30-minute marketing audit and let&apos;s discuss how I
      ...
      <footer className="bg-[#2a2927] py-12 px-8 border-t border-gray-800">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xs text-gray-400 leading-relaxed max-w-3xl mx-auto mb-4">
            ...
            affiliation with this website or with me personally.
          </p>
