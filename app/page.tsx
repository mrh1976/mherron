    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-8 px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="relative mx-auto mb-6 w-[700px] h-[700px] overflow-hidden">
            <Image 
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent via-55% to-white pointer-events-none"></div>
          </div>
