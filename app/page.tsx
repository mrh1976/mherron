      ...
      <section className="pt-32 md:pt-40 pb-16 md:pb-20 px-6 md:px-8 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="relative z-10 text-[19px] md:text-[21px] text-[#6b6b6b] max-w-2xl mx-auto leading-relaxed -mt-16 md:-mt-24">
            Based in Chicago, I&apos;m a marketing executive with 20+ years of experience and a
  ...
  return (
    <section className="py-24 md:py-32 px-8 bg-white">
      <div className="max-w-[1100px] mx-auto">
        ...
        {/* Grid of 4 Testimonials - 2x2 */}
        <div className="grid md:grid-cols-2 gap-5">
          {/* Testimonial 1 - John Geletka */}
      ...
      <section id="work" className="py-24 md:py-32 px-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Portfolio Grid - 4 columns, square images */}
      ...
      <section className="py-24 md:py-32 px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-[36px] md:text-[48px] lg:text-[56px] font-[800] mb-8 leading-[1.05] tracking-[-2.5px]">
            Start With a Free Audit<span className="text-yellow-400">.</span>
          </h2>
          <p className="text-[#6b6b6b] text-[19px] md:text-[21px] leading-relaxed mb-12 max-w-2xl mx-auto">
            Not ready to commit? No problem. Book a free 45-minute marketing audit and I'll help you identify what's working, what's not, and where the biggest opportunities are.
          </p>
          
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div>
              <div className="text-4xl mb-4">🔍</div>
              <h3 className="font-[600] mb-2">Strategy Review</h3>
              <p className="text-sm text-gray-600">Current positioning, messaging, and go-to-market approach</p>
            </div>
            <div>
              <div className="text-4xl mb-4">📊</div>
              <h3 className="font-[600] mb-2">Gap Analysis</h3>
              <p className="text-sm text-gray-600">What's missing and what's not working</p>
            </div>
            <div>
              <div className="text-4xl mb-4">💡</div>
              <h3 className="font-[600] mb-2">Action Plan</h3>
              <p className="text-sm text-gray-600">3-5 immediate improvements you can implement</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-24 md:py-32 px-8 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#6b6b6b] text-[17px] md:text-[19px] leading-relaxed mb-12 max-w-2xl mx-auto text-center">
            Before we work together, let's diagnose what's holding your marketing back. In your free 45-minute audit, I'll review your current strategy, identify gaps, and provide 3-5 actionable recommendations. No pitch, just honest feedback.
          </p>
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            Have questions? Use the form above to get in touch.
          </p>
        </div>
      </section>
      ...
      <footer className="bg-white py-12 px-8 border-t border-gray-100">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xs text-gray-400 mb-2">©2026 Michael Herron LLC | Chicago, IL</p>
