...
const project = projects.find((p) => p.id === 'croatian-football')!;
const nextProject = projects.find((p) => p.id === 'lukka-driven-by-data')!;
const prevProject = projects.find((p) => p.id === 'newkadena')!;
...
export default function CroatianFootballPage() {
