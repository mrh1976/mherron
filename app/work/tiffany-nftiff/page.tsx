...
const project = projects.find((p) => p.id === 'tiffany-nftiff')!;

// DYNAMIC CALCULATION - respects order in projectsData.ts
const currentIndex = projects.findIndex((p) => p.id === 'tiffany-nftiff');
...
export default function TiffanyNFTiffPage() {
  const projectType = 'Brand Partnership';
