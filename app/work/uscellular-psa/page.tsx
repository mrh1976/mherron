...
const project = projects.find((p) => p.id === 'uscellular-psa')!;
const nextProject = projects.find((p) => p.id === 'uscellular-activations')!;
const prevProject = projects.find((p) => p.id === 'hrblock')!;
...
export default function USCellularPSAPage() {
  const projectType = 'Brand Campaign';
