...
const project = projects.find((p) => p.id === 'lukka-unicorn')!;
const nextProject = projects.find((p) => p.id === 'new-england-patriots')!;
const prevProject = projects.find((p) => p.id === 'uscellular-activations')!;
...
export default function LukkaUnicornPage() {
  const projectType = 'Brand & Growth Strategy';
