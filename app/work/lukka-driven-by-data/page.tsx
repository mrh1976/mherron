...
const project = projects.find((p) => p.id === 'lukka-driven-by-data')!;
const nextProject = projects.find((p) => p.id === 'hrblock')!;
const prevProject = projects.find((p) => p.id === 'croatian-football')!;
...
export default function LukkaDrivenByDataPage() {
