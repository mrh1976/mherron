  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 lg:pb-[900px] relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div className="flex flex-col justify-start mt-16 lg:absolute lg:left-4 lg:top-8 lg:z-10 lg:w-2/3">
              ...
              <div className="space-y-4 mt-96 flex flex-col items-start lg:items-start">
            ...
            <div className="hidden lg:flex lg:justify-end lg:absolute lg:right-4 lg:top-8 lg:h-full lg:items-start">
              {/* Profile Image */}
              <img
                ...
                alt="Mike Herron"
                className="max-w-xl lg:max-w-2xl object-cover rounded-lg"
              />
            </div>
          </div>
        </div>
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20 mb-16">
          <div className="w-full max-w-2xl bg-gradient-to-r from-black to-gray-800 rounded-2xl p-8 flex items-center justify-center gap-8 shadow-lg lg:ml-auto">
            {/* Logo/Icon */}
